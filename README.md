About portend-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/portend-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5093&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/portend-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `portend` can be installed with `conda`:
...
```
mamba install portend
```

It is possible to list all of the versions of `portend` available on your platform with `conda`:
...
```
mamba search portend --channel conda-forge
```
...
mamba repoquery search portend --channel conda-forge

# List packages depending on `portend`:
mamba repoquery whoneeds portend --channel conda-forge

# List dependencies of `portend`:
mamba repoquery depends portend --channel conda-forge
```
